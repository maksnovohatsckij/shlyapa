...
<body>
    ...
    <header>
        <h1>Шляпа 👒</h1>
        <span><a style="transition: 0.1s;" href="https://github.com/maksnovohatsckij/shlyapa" target="_blank" class="text-secondary">GitHub</a></span>
    </header>
    ...
    <div id="setgamename" class="container p-2">
        <a class="text-right px-3 text-dark" id="feedback" href="https://docs.google.com/forms/d/e/1FAIpQLSee_r7g7Mabuan3DNWQcj4YU5m48ns4t5oGl5vOFid9FUWLvw/viewform?vc=0&c=0&w=1&usp=mail_form_link" target="_blank">Отзыв</a>
